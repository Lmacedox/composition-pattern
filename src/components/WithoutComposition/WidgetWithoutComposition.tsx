import { Camera, Check, Rocket, X } from 'lucide-react'
  ...
  return (
    <div className="w-[448px] rounded overflow-hidden">
      ...
      <div>
        ...
        <div className="bg-zinc-200 bg-zinc-900 px-8 py-4 flex items-start gap-6">
          ...
          <div className="flex gap-2 self-center">
            <button className="w-8 h-8 rounded flex items-center justify-center bg-zinc-400 hover:bg-zinc-500 bg-zinc-800">
